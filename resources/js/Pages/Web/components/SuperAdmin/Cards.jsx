...
const Cards = ({ userStats }) => {
    ...
    return (
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4 my-[50px]">
            <div className="w-full h-[100px] flex flex-col gap-2 border border-[#343B4F] bg-[#0B1739] rounded-[5px] pt-4 pl-4 pr-4 relative">
                ...
                <div className="flex flex-row items-center gap-2">
                    ...
                    <div className="w-[50px] h-[20px] flex justify-center items-center border border-[#05C16833] bg-[#05C16833] rounded-[5px]">
                        <h1 className="flex items-baseline text-green-400 px-1 text-[14px] font-medium">28.4%</h1>
            ...
            <div className="w-full h-[100px] flex flex-col gap-2 border border-[#343B4F] bg-[#0B1739] rounded-[5px] pt-4 pl-4 pr-4 relative">
                ...
                <div className="flex flex-row items-center gap-2">
                    ...
                    <div className={'w-[50px] h-[20px] flex justify-center items-center border rounded-[5px] ' + (stats.isMonthlyGrowthPositive ? 'border-[#05C16833] bg-[#05C16833]' : 'border-[#FF5A6533] bg-[#FF5A6533]')}>
                        <h1 className={'flex items-baseline px-1 text-[14px] font-medium ' + (stats.isMonthlyGrowthPositive ? 'text-green-400' : 'text-[#FF5A65]')}>{Math.abs(stats.monthlyGrowth)}%</h1>
            ...
            <div className="w-full h-[100px] flex flex-col gap-2 border border-[#343B4F] bg-[#0B1739] rounded-[5px] pt-4 pl-4 pr-4 relative">
                ...
                <div className="flex flex-row items-center gap-2">
                    ...
                    <div className={'w-[50px] h-[20px] flex justify-center items-center border rounded-[5px] ' + (stats.isSignupGrowthPositive ? 'border-[#05C16833] bg-[#05C16833]' : 'border-[#FF5A6533] bg-[#FF5A6533]')}>
                        <h1 className={'flex items-baseline px-1 text-[14px] font-medium ' + (stats.isSignupGrowthPositive ? 'text-green-400' : 'text-[#FF5A65]')}>{Math.abs(stats.signupGrowth)}%</h1>
                        <img src={externalR} className="size-[9px] md:w-[10px]" alt="trend" />
                    </div>
                </div>
            </div>
            ...
            <div className="w-full h-[100px] flex flex-col gap-2 border border-[#343B4F] bg-[#0B1739] rounded-[5px] pt-4 pl-4 pr-4 relative">
                ...
                <div className="flex flex-row items-center gap-2">
                    ...
                    <div className="w-[50px] h-[20px] flex justify-center items-center border border-[#05C16833] bg-[#05C16833] rounded-[5px]">
                        <h1 className="flex items-baseline text-green-400 px-1 text-[14px] font-medium">100%</h1>
                        <img src={externalR} className="size-[9px] md:w-[10px]" alt="external link" />
                    </div>
                </div>
            </div>
