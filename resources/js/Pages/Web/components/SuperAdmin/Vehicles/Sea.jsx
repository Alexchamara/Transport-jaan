...
const Sea = ({ statusFilter, approvalFilter }) => {
    const [seaVehicles, setSeaVehicles] = useState([
        {
            id: 1,
            name: "Cargo Ship",
            model: "Maersk",
    ...
    const filteredVehicles = seaVehicles.filter((vehicle) => {
        const matchesStatus =
            statusFilter === "" ||
            statusFilter === "all" ||
