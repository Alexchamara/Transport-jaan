...
import SeaVehicleDetailsTab from "./SeaVehicleDetailsTab";
import PoliciesTab from "./PoliciesTab";
import ReviewsTab from "./ReviewsTab";
import GalleryTab from "./GalleryTab";

const SeaVehicleInfo = () => {
  const { props } = usePage();
    ...
    <div className="poppins w-full h-auto">
      ...
      <div className="py-10">
        <div className="flex flex-col md:flex-row md:gap-20 px-20 text-[12px] font-[600] text-[#00000080] border-b-[2px] border-[#0000001F]">
          {[
            { key: "sea-vehicle-details", label: "Sea Vehicle Details" },
      ...
      {/* Tab content */}
      {selectedTab === "plane-details" && <SeaVehicleDetailsTab vehicle={vehicle} />}
