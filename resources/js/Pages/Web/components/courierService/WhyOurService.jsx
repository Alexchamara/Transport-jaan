...
const WhyOurService = () => {
    return (
        ...
        <div className="w-full flex flex-col md:flex-row md:gap-10 gap-8 justify-center items-center md:items-start poppins mt-10">
            ...
              </div>
                ...
                <div className="flex flex-col md:flex-row justify-center items-center py-20 gap-8 md:gap-12 xl:gap-28">
                    ...
                    <div className="hidden md:block md:max-w-xs lg:max-w-none">
                        <img src={dDoor} alt="Delivery to your doorstep" className="w-full h-auto" />
                    </div>
