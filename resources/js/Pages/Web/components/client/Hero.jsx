                ...
                <div className="mb-6 flex flex-col gap-4 md:mb-10 md:flex-row md:items-center md:justify-between">
                    <div className="flex flex-col gap-2">
                        <h1 className="text-2xl font-bold tracking-tight md:text-[35px]">
                            Your <span className="text-[#0955AC]"> Rentals Dashboard</span>
                        </h1>
                ...
                <div className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm">
                        <div className="px-5 pt-5 pb-2">
                            ...
                            <h3 className="text-[26px] font-[700] text-[#0955AC]">12</h3>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm">
                        <div className="px-5 pt-5 pb-2">
                            ...
                            <h3 className="text-[26px] font-[700] text-[#0955AC]">47h</h3>
                        </div>
                        <div className="px-5 pb-5 text-[12px] text-[#7B7B7A]">
                            2 upcoming missions
                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm">
                        <div className="px-5 pt-5 pb-2">
                            ...
                            <h3 className="text-[26px] font-[700] text-[#0955AC]">9</h3>
                        </div>
                        <div className="px-5 pb-5 text-[12px] text-[#7B7B7A]">
                            +2 vs last month
                        </div>
                ...
                <div className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <div className="lg:col-span-2 bg-white rounded-[10px] shadow-sm">
                        ...
                        <div className="px-10 pb-10 pt-10">
                            <div className="h-[350px] w-full focus:outline-none focus:border-none" style={{ WebkitTapHighlightColor: 'transparent', outline: 'none' }}>
                                <ResponsiveContainer
                                      width="100%"
                                      height="100%"
