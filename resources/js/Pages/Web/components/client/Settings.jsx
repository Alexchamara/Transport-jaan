 ...
 * - Profile photo upload with preview & validation
 * - Personal details (name, email, phone)
 * - Address
 * - Security (change password with client-side checks)
 * - Payment details (tokenized-friendly fields)
 * - Notification preferences
 *
 * Submits to route `client.settings.update` (Ziggy) or `/client/settings`.
 */
...
const Settings = ({ user = {} }) => {
    ...
    return (
        <div className="bg-[#E5E5E5] poppins">
            <div className="max-w-[1300px] mx-auto px-4 md:px-6 lg:px-10 py-20">
                ...
                <form onSubmit={submitAll} className="space-y-8" noValidate>
