...
const VendorCancellationModal = ({ booking, isOpen, onClose, onSuccess }) => {
                            ...
                            <div className="px-6 py-6">
                                                ...
                                                <div className="bg-slate-50 rounded-lg p-4 space-y-3">
                                                    <div className="flex justify-between items-center">
                                                        ...
                                                        <span className="font-semibold text-slate-900">
                                                            Rs {(parseFloat(booking.payment) || 0).toFixed(2)}
                                                        </span>
                                                    </div>
                                                    <div className="flex justify-between items-center">
                                                    ...
                                                    <div className="flex justify-between items-center pt-3 border-t border-slate-200">
                                                        <span className="font-semibold text-slate-900">Customer Will Receive:</span>
                                                        <span className="text-2xl font-bold text-green-600">
                                                            Rs {policyData.refund_details?.refund_amount?.toFixed(2) || "0.00"}
                                                        </span>
                                                    </div>
                                                </div>
                                ...
                                {step === "confirm" && (
                                    <div className="space-y-4">
                                        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                                            <p className="text-sm text-amber-900">
                                                <strong>Note:</strong> Cancelling this booking will process a refund to the customer. This action cannot be undone.
                                            </p>
                                        </div>
                                ...
                                {step === "processing" && (
                                    <div className="flex flex-col items-center justify-center py-8">
                                        ...
                                        <p className="text-slate-600 font-medium">Processing cancellation...</p>
                                    </div>
                                )}
                                    ...
                                    <div className="flex flex-col items-center justify-center py-8">
                                        ...
                                        <p className="text-slate-600 text-center text-sm mb-4">
                                            Refund of <strong className="text-green-600">
                                                Rs {policyData?.refund_details?.refund_amount?.toFixed(2) || "0.00"}
                                            </strong> will be processed to the customer.
                                        </p>
...
export default VendorCancellationModal;
