...
const ReservationContent = () => {
        ...
        const fetchReservations = async () => {
            try {
                ...
                const response = await axios.get(
                    `${API_BASE_URL}vendors/warehouse/api/reservations`
                );

                if (response.data.success) {
                    const decorated =
                        response.data.data.map(decorateReservation);
    ...
    useEffect(() => {
        const fetchStats = async () => {
            try {
                const response = await axios.get(
                    `${API_BASE_URL}vendors/warehouse/api/reservations/stats`
                );
    ...
    useEffect(() => {
        const fetchChartData = async () => {
            try {
                const response = await axios.get(
                    `${API_BASE_URL}vendors/warehouse/api/reservations/chart-data`
                );
            ...
            <div className="mt-10">
                {loading ? (
                    ...
                    <div className="bg-white rounded-lg p-6 shadow">
                        <h2 className="text-[24px] font-[700] mb-4">
                            Raw Data
                        </h2>
