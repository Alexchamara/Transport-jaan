      ...
      <div className="flex flex-col gap-5 py-10">
        <div className="flex flex-col xl:flex-row gap-5">
          ...
          <div className="flex flex-col gap-5 w-full">
            ...
            <div className="flex flex-col gap-5">
              <div className="flex xl:flex-row flex-col gap-5 justify-between w-full">
                {/* Total Revenue */}
                <div className="min-w-[300px] w-full min-h-[91px] bg-white rounded-[8px] flex justify-between items-center gap-2 px-5 py-2"
                  ...
                  <div className="flex flex-row gap-5 items-center">
                    ...
                    <div>
                      <h1 className="text-[14px] font-[500] text-[#7B7B7A]">Total Revenue</h1>
                      <h1 className="text-[24px] font-[700]">{fmtMoney(cards?.totalRevenue ?? 0)}</h1>
                    </div>
                  </div>
                ...
                <div className="min-w-[300px] w-full min-h-[91px] bg-white rounded-[8px] flex justify-between items-center gap-2 px-5 py-2"
                  ...
                  <div className="flex flex-row gap-5 items-center">
                    ...
                    <div>
                      <h1 className="text-[14px] font-[500] text-[#7B7B7A]">New Bookings</h1>
                      <h1 className="text-[24px] font-[700]">{cards?.newBookings ?? 0}</h1>
                    </div>
                  </div>
                  <div className="flex flex-col gap-2 items-end text-[14px] font-[500]">
                    <div className="w-[81px] h-[26px] bg-[#D8E4F2] rounded-[5px] flex flex-row justify-center items-center">
              ...
              <div className="flex xl:flex-row flex-col gap-5 w-full">
                ...
                <div className="min-w-[300px] w-full min-h-[91px] bg-white rounded-[8px] flex justify-between items-center gap-2 px-5 py-2"
                  ...
                  <div className="flex flex-row gap-5 items-center">
                    ...
                    <div>
                      <h1 className="text-[14px] font-[500] text-[#7B7B7A]">Rented Cars</h1>
                      <h1 className="text-[24px] font-[700]">{cards?.rentedCars ?? 0} Units</h1>
                    </div>
                  </div>
                  <div className="flex flex-col gap-2 items-end text-[14px] font-[500]">
                ...
                {/* Total Cars */}
                <div className="min-w-[300px] min-h-[91px] w-full bg-white rounded-[8px] flex justify-between items-center gap-2 px-5 py-2"
                     style={{ boxShadow: "4px 4px 4px #0000001A" }}>
                  <div className="flex flex-row gap-5 items-center">
                    <div className="size-[50px] bg-[#D8E4F2] rounded-full flex justify-center items-center">
                      <img src={carIcon} />
                    ...
                    <div>
                      <h1 className="text-[14px] font-[500] text-[#7B7B7A]">Total Cars</h1>
                      <h1 className="text-[24px] font-[700]">{cards?.totalCars ?? 0} Units</h1>
                    </div>
                  </div>
                  <div className="flex flex-col gap-2 items-end text-[14px] font-[500]">
                    <div className="w-[81px] h-[26px] bg-[#D8E4F2] rounded-[5px] flex flex-row justify-center items-center">
            ...
            {/* Booking Overview */}
            <div className="min-w-auto h-auto bg-white flex flex-col justify-center items-center rounded-[10px] py-10 px-10"
                 style={{ boxShadow: "4px 4px 4px #0000001A" }}>
            ...
            {/* Earning Summary */}
            <div className="min-w-auto min-h-[381px] bg-white rounded-[10px] py-10 px-10"
                 style={{ boxShadow: "4px 4px 4px #0000001A" }}>
          ...
          <div className="flex flex-col items-center gap-5 w-full">
            {/* Car Availability */}
            <div className="min-w-auto w-full xl:min-h-[206px] bg-[#D8E4F2] flex flex-col px-10 py-5 justify-center items-center rounded-[10px]"
                 style={{ boxShadow: "4px 4px 4px #0000001A" }}>
            ...
            {/* Real Status */}
            <div className="min-w-auto w-full min-h-[427px] bg-white rounded-[10px] py-5 px-10"
                 style={{ boxShadow: "4px 4px 4px #0000001A" }}>
            ...
            {/* Reminders */}
            <div className="min-w-auto w-full min-h-[335px] bg-white rounded-[10px] py-5 px-10"
                 style={{ boxShadow: "4px 4px 4px #0000001A" }}>
              <div className="flex flex-row items-center justify-between w-full">
        ...
        <div className="flex flex-col xl:flex-row gap-5 justify-between">
          <div className="min-w-auto w-full min-h-[858px] bg-white rounded-[10px] px-10 py-10"
               style={{ boxShadow: "4px 4px 4px #0000001A" }}>
