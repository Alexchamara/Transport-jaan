            ...
            <div className='bg-[#D9D9D9] rounded-[16px] sm:rounded-[20px] px-4 sm:px-8 lg:px-14 py-6 sm:py-8 lg:py-10'>
                <div className='flex flex-col lg:flex-row gap-6 lg:gap-8 items-start lg:items-center'>
                    ...
                    <div className='flex flex-col gap-2'>
                        <div className='poppins font-bold text-[28px] sm:text-[36px] lg:text-[45px] leading-tight'>Steve Gibson</div>
                        <div className='flex flex-wrap gap-2 sm:gap-3 items-center'>
                            <img className='w-[24px] h-[24px] sm:w-[32px] sm:h-[32px]' src={Start} alt="Star" />
                            <div className='poppins text-[20px] sm:text-[26px] lg:text-[32px]'>4.0</div>
                            <div className='poppins text-[18px] sm:text-[22px] lg:text-[30px] text-[#949699]'>(180 Reviews)</div>
                        </div>
                        <div className='poppins text-[16px] sm:text-[20px] lg:text-[24px] text-[#949699]'>Joined 7 months ago</div>
                    </div>
