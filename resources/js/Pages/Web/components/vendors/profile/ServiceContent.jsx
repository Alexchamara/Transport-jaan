...
const ServiceContent = ({ activeService, activeMode, services, landVehicles = [], seaVehicles = [], airVehicles = [], authUser, likedVehicleIds = [] }) => {
    ...
    if (activeService === 'Warehousing') {
        return (
            <div className='w-full max-w-[1364px] mx-auto px-4 sm:px-6 xl:px-10 py-6'>
                ...
                <div className='bg-gray-50 border border-gray-200 rounded-lg px-6 py-8 text-center'>
                    <p className='text-gray-600'>Warehouse information will be displayed here.</p>
                </div>
            </div>
        );
    }
    ...
    if (activeService === 'Freight') {
        return (
            <div className='w-full max-w-[1364px] mx-auto px-4 sm:px-6 xl:px-10 py-6'>
                ...
                <div className='bg-gray-50 border border-gray-200 rounded-lg px-6 py-8 text-center'>
                    <p className='text-gray-600'>Freight service information will be displayed here.</p>
                </div>
            </div>
        );
    }
    ...
    if (activeService === 'Courier Service') {
        return (
            <div className='w-full max-w-[1364px] mx-auto px-4 sm:px-6 xl:px-10 py-6'>
                ...
                <div className='bg-gray-50 border border-gray-200 rounded-lg px-6 py-8 text-center'>
                    <p className='text-gray-600'>Courier service information will be displayed here.</p>
                </div>
            </div>
        );
    }
