...
function BookingBarChart() {
  ...
  return (
    <div className="w-full h-full flex flex-col items-stretch relative px-2 md:px-4 lg:px-8 pt-4 md:pt-8 pb-4">
      {/* Header */}
      <div className="flex flex-row justify-between items-center mb-6">
        <div className="flex flex-col gap-2">
          <h2 className="text-[24px] md:text-[28px] font-[700]">Booking Overview</h2>
        ...
        <div className="ml-8">
          <button className="bg-[#F3F3F3] rounded-lg px-3 md:px-4 py-2 flex flex-row items-center gap-2 text-[14px] md:text-[16px] font-[500] text-[#7B7B7A] shadow-none border-none outline-none">
            Last 8 months
