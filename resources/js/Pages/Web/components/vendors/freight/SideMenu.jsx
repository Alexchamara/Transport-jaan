...
const SideMenu = () => {
    ...
    return (
      ...
      `}</style>
            ...
            <div className="poppins min-w-[279px] min-h-screen bg-[#FFFFFF] flex flex-col py-4 px-6 rounded-tr-[10px] rounded-br-[10px] sticky top-0 left-0 shadow-lg overflow-hidden">
