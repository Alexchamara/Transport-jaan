...
const SideMenu = () => {
  ...
  return (
    <>
      ...
      `}</style>
      <div className="poppins min-w-[289px] h-screen bg-[#FFFFFF] flex flex-col py-4 px-6 rounded-tr-[10px] rounded-br-[10px] sticky top-0 left-0 shadow-lg overflow-hidden">
        {/* Logo - Fixed at top */}
        ...
        <div
          ...
          onClick={() => (window.location.href = "/vendors/dashboard")}
        >
        ...
        <div
          className={`flex flex-row justify-start items-center gap-5 cursor-pointer w-full rounded-lg px-3 py-1.5 ${
            ["/vendors/payment", "/vendors/expenses"].includes(currentPath)
              ? "bg-[#0955AC29] text-[#000000] font-[700]"
              : "text-[#00000066]"
          }`}
        >
