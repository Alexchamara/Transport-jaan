...
const handleFuelChange = (fuel) => {
  ...
  const brands = [
    { id: "yamahaMarine", label: "Yamaha Marine", count: 15 },
    { id: "saeDoo", label: "Sea-Doo", count: 12 },
    { id: "bayliner", label: "Bayliner", count: 18 },
    { id: "quicksilver", label: "Quicksilver", count: 10 },
    { id: "beneteau", label: "Beneteau", count: 14 },
    { id: "princess", label: "Princess", count: 9 },
    { id: "sunseeker", label: "Sunseeker", count: 11 },
    { id: "azimutYachts", label: " Azimut Yachts", count: 11 },
    { id: "ferretti", label: "Ferretti", count: 11 },
    { id: "masterCraft", label: "Master Craft", count: 11 },
  ];
