...
const Hero = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center px-4 py-5 xl:px-10 xl:py-10">
            <div className="max-w-[1400px] w-full">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-5 mt-5">
                    <div className="xl:col-span-2">
                        <div className="w-full h-auto xl:h-[777px] bg-[#F4F3F3] shadow-xl rounded-[20px] p-4 xl:p-8">
                            ...
                            <div className="mt-10">
                                ...
                                <div className="flex flex-col sm:flex-row text-[14px] text-[#0A0A0A] gap-5 sm:gap-20 mt-3">
                    ...
                    <div className="xl:col-span-1">
                        <div className="w-full h-auto xl:h-[777px] bg-[#F4F3F3] shadow-xl rounded-[20px] p-5">
                ...
                <div className="w-full flex flex-col lg:flex-row items-center gap-3 h-auto xl:h-[160px] bg-[#F4F3F3] rounded-[20px] shadow-xl mt-10 p-5 font-[500] text-[#0A0A0A]">
                    <div>
                ...
                <div className="mt-10">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-center mt-5 gap-5">
                        <div className="xl:w-[389px] xl:h-[152px] shadow-lg flex flex-row justify-start gap-3 items-center border-[0.8px] border-[#E5E7EB] rounded-[10px] px-4 py-2">
                            <img
                                src={bus1}
                                alt="Bus 1"
                    ...
                    <div className="px-5">
                        ...
                        <div className="flex flex-col mt-10 items-center">
                            <div className="mx-auto">
                                ...
                                <div className="grid grid-cols-6 justify-center gap-2 items-center w-full max-w-[320px] sm:max-w-[480px] text-[12px] overflow-x-auto">
                                {/* 1st row */}
