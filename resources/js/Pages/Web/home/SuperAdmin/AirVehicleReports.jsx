...
const AirVehicleReports = ({ bookings = [], stats = {} }) => {
  return (
    <div className='flex flex-row bg-[#081028] min-h-screen sm:flex-col md:flex-row lg:flex-row poppins'>
      ...
      <div className='flex-1 p-8'>
        <div className='max-w-7xl mx-auto'>
          <h1 className='text-white text-3xl font-bold mb-6'>Air Vehicle Bookings Report</h1>
          <p className='text-gray-400 mb-8'>Detailed report of all air vehicle bookings.</p>
                  ...
                  <tbody>
                    {bookings.map((booking, index) => (
                      <tr key={index} className='border-b border-gray-800'>
                        ...
                        <td className='text-gray-300 py-3 px-2'>
                          {booking.route ? `${booking.route.from} → ${booking.route.to}` : 'N/A'}
                        </td>
...
export default AirVehicleReports;
