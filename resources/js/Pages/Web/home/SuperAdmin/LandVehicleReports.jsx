...
const LandVehicleReports = ({ bookings = [], stats = {} }) => {
  return (
    <div className='flex flex-row bg-[#081028] min-h-screen sm:flex-col md:flex-row lg:flex-row poppins'>
      ...
      <div className='flex-1 p-8'>
        <div className='max-w-7xl mx-auto'>
          <h1 className='text-white text-3xl font-bold mb-6'>Land Vehicle Bookings Report</h1>
          <p className='text-gray-400 mb-8'>Detailed report of all land vehicle bookings.</p>
...
export default LandVehicleReports;
