    ...
    return (
        <div className="bg-[#E5E5E5] h-auto min-h-screen">
            <div className="flex flex-row gap-10 h-auto">
                ...
                {/* Side Menu */}
                <div
                    className={`fixed xl:static top-0 left-0 h-screen w-64 z-40 transition-transform duration-300
          ${isOpen ? "translate-x-0" : "-translate-x-full"}
          xl:translate-x-0 bg-white shadow xl:shadow-none overflow-hidden`}
                >
