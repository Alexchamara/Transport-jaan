...
class ClientCourierShipmentTransformerTest extends TestCase
{
    ...
    private function makeShipmentFixture(): CourierShipment
    {
        ...
        $packageOne->weight_kg = 5.50;
        $packageOne->quantity = 1;
        $packageOne->quoted_price_usd = 8.25;
        $packageOne->length_cm = 25.0;
        $packageOne->width_cm = 20.0;
        $packageOne->height_cm = 10.0;
        $packageOne->declared_value = 200.00;
        ...
        $packageTwo->weight_kg = 1.50;
        $packageTwo->quantity = 1;
        $packageTwo->quoted_price_usd = 2.50;
        ...
        $shipment->pickup_date = Carbon::parse('2026-03-25');
