...
class Vehicle extends Model
{
    ...
    protected $fillable = [
        'provider_id', 'type', 'category_id',
        'model', 'manufacturer', 'manufacture_year', 'registration_year',
        'registration_number', 'colour', 'condition', 'ownership_type',
        'passenger_capacity', 'mileage_km',
        'rental_price_per_day', 'total_rental_price', 'deposit_amount', 'advance_payment_amount', 'currency',
        'insurance_provider', 'insurance_policy_number',
        'gps', 'child_seat', 'wifi', 'insurance_coverage',
        'extra',
        'contact_name', 'contact_email', 'contact_phone',
        'address', 'city', 'state', 'postal_code', 'country', 'latitude', 'longitude',
        'status', 'approval_status', 'approved_by', 'approved_at',
        'description',
        'images_json', 'insurance_docs_json',
    ];
